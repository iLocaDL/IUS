...
const mockNews: News[] = [
  {
    id: '1',
    title: 'Vittoria straordinaria contro i rivali',
    date: '2025-11-30',
    content: 'La squadra IUS ASD ha conquistato una vittoria straordinaria con un punteggio di 5-2. Una prestazione eccezionale che dimostra il grande lavoro di squadra e la dedizione dei nostri giocatori.',
  ...
  },
  {
    ...
    date: '2025-11-28',
    content: 'Siamo lieti di annunciare l\'arrivo di Coach Marco Rossi che guiderà la nostra squadra di bambini. Con oltre 15 anni di esperienza, porterà nuove metodologie di allenamento.',
    image: 'https://images.pexels.com/photos/260024/pexels-photo-260024.jpeg?auto=compress&cs=tinysrgb&w=800'
  },
  {
    id: '3',
    title: 'Torneo di beneficenza questo weekend',
    date: '2025-11-25',
    content: 'IUS ASD organizza un torneo di beneficenza per raccogliere fondi per l\'associazione locale. Tutti sono invitati a partecipare e sostenere questa iniziativa.',
  ...
  {
    id: '4',
    title: 'Inaugurazione nuovo campo da allenamento',
    date: '2025-11-20',
    content: 'Grande festa per l\'inaugurazione del nostro nuovo campo da allenamento. Una struttura moderna che permetterà ai nostri atleti di allenarsi nelle migliori condizioni.',
